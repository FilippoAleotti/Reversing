...
"""
Evaluate your depth maps on Middlebury dataset
"""
...
parser = argparse.ArgumentParser(description="Middlebury test")
...
def test():
    """Run test on Middlebury.
        Some images are more diffucult than others, so we use a 0.5 weight
    """
